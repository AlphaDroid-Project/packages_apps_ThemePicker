...
package com.android.alpha.themepicker.ui.theme
...
data class ExpressiveMotion(
    val emphasisHigh: MotionSpec =
        MotionSpec(dampingRatio = Spring.DampingRatioLowBouncy, stiffness = Spring.StiffnessLow),
    val emphasisMedium: MotionSpec =
        MotionSpec(
            dampingRatio = Spring.DampingRatioMediumBouncy,
            stiffness = Spring.StiffnessMedium,
        ),
    val emphasisLow: MotionSpec =
        MotionSpec(dampingRatio = Spring.DampingRatioNoBouncy, stiffness = Spring.StiffnessHigh),
    val buttonPress: MotionSpec = MotionSpec(dampingRatio = 0.6f, stiffness = 400f),
    val cardPress: MotionSpec = MotionSpec(dampingRatio = 0.65f, stiffness = 350f),
    val containerTransform: MotionSpec = MotionSpec(dampingRatio = 0.8f, stiffness = 380f),
    val screenEnter: MotionSpec = MotionSpec(dampingRatio = 0.85f, stiffness = 400f),
    val screenExit: MotionSpec = MotionSpec(dampingRatio = 1f, stiffness = 500f),
...
@Immutable
data class MotionSpec(val dampingRatio: Float, val stiffness: Float) {
    fun <T> asSpring() = spring<T>(dampingRatio = dampingRatio, stiffness = stiffness)
}
...
fun Modifier.bounceable(onClick: () -> Unit, scale: Float = 0.96f): Modifier = composed {

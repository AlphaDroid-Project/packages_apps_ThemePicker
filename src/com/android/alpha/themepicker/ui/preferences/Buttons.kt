...
package com.android.alpha.themepicker.ui.preferences
        ...
        Box(
            modifier =
                Modifier.size(iconSize * 2)
                    ...
                    .background(
                        backgroundColor
                            ?: if (enabled) colors.primary.copy(alpha = 0.2f) else colors.surface
                    ),
                ...
                when {
                    ...
                    icon != null -> {
                        Icon(
                            imageVector = icon,
                            contentDescription = label,
                            tint = primaryTint ?: if (enabled) colors.primary else colors.secondary,
                            modifier = Modifier.size(iconSize),
                        )
                    }
                }
